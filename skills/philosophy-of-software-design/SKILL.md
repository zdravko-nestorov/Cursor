...
description: >-
  Module and API design: deep modules, information hiding, cognitive load. Use when designing modules, APIs, decomposition, refactoring structure, or reducing complexity.
---
