...
description: >-
  Clean Architecture boundaries and dependency rule. Use when separating business policy from frameworks/DB/UI, reviewing layering, ports/adapters, or protecting domain from details.
---
