...
description: >-
  Data-intensive system design: reliability, scalability, consistency, replication, partitioning, streams, schema evolution. Use when designing data stores, events, consistency models, or distributed data flows.
---
