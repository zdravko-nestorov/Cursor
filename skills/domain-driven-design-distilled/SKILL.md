...
description: >-
  Strategic DDD: subdomains, bounded contexts, context mapping, ubiquitous language. Use when modeling domains, drawing context maps, or aligning code to business capabilities.
---
